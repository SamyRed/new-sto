            ...
            <form action="#">
                <div class="modal-body">
                    <div class="input-group mb-3 ui-widget">
                        <label for="companyAddWorkerTitle" class="input-group-text">{WORKER_TITLE}:</label>
                        <input type="text" class="form-control" name="title" id="companyAddWorkerTitle" placeholder="{WORKER_TITLE}">
                    </div>
                </div>
